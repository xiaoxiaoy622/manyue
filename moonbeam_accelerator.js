...
(function () {
    ...
    var _cssText = [
        ...
        // --- 面板卷轴 ---
        // ====================================================================
        '#moon-panel{position:fixed;top:170px;left:20px;z-index:2147483646;width:360px;visibility:hidden;pointer-events:none;perspective:1500px}',
        ...
        '@media (max-width:480px){' +
            ...
            // 面板缩小 - 移动端固定宽度260px
            '#moon-panel{top:115px;left:10px;width:260px;max-width:260px}' +
        ...
        '@media (max-width:374px){' +
            ...
            '#moon-panel{top:100px;left:8px;width:240px;max-width:240px}' +
